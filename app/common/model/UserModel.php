...
class UserModel extends BaseModel
{
    ...
    {
        ($value != null) && $query->where('nickname', 'like', "%{$value}%");
    }
    ...
    {
        ($value != null) && $query->where('pid', '=', $value);
    }
    ...
    {
        return $this->hasMany(UserInviteModel::class, 'user_id','id');
    }
...
//    }
    ...
    protected function getInviteCodeAttr($value)
    {
        return ImgUrlTool::addPrefix($value);
    }
